...
- Кнопка Удалить в модалке подтверждения удаления лид-формы удаляет её из списка
...
- Нажатие кнопки Назад возвращает на предыдущую страницу формы
### Окно предпросмотра
...
- Кнопка Добавить вопрос открывает дополнительную форму
...
- Нажатие на кнопку Добавить контактные данные открывает модалку со списком контактных полей
...
- Нажатие на ссылку Требования к медифайлам в правом верхнем углу ведет на страницу справки
...
- Если перетащить в область загрузки медиафайлов файл недопустимого формата, появляется нотифай с ошибкой
...
- Поиск. Если при поиске нет совпадений, отображается сообщение об этом
...
- При вводе поискового запроса открывается страница поиска
- Нажатие на карточку категории в списке ведет на страницу категории
- Кнопка Перейти в кабинет ведет в личный кабинет
- Ссылки в списке разделов ведут на страницы соответствующих разделов
## Страница категории
<img src="files/Pasted image 20240414174849.png" width=900>

- Справа – область контента категории, слева – навигациооная панель
- Выбор категории в навигационной панели ведет на страницу соответствующей категории
- Ссылки на подкатегории в области контента категории ведут на страницы соответствующих подкатегорий
- Ссылки на статьи в области контента категории ведут на страницы соответствующих статей
## Страница поиска
...
- Нажатие на карточку кейса ведет на страницу кейса
## Страница кейса
...
- Переключатель форматов меняет содержимое страницы
